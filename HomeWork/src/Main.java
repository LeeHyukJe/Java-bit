...
public class Main extends JFrame implements ActionListener {
	...
	public Main(String title) {
		...
		clearButton.addActionListener(this); //?Å¥Î¶¨Ïñ¥Î≤ÑÌäº
		...
		//Î≤ÑÌäº Î∂ôÏù¥Í∏?
		buttonBox.add(clearButton); //?Å¥Î¶¨Ïñ¥ Î≤ÑÌäº
		buttonBox.add(RedColorButton); //ÎªòÍ≤ãÍ≤? Ïπ†ÌïòÍ∏?
		buttonBox.add(GreenColorButton); //?Öπ?Éâ?úºÎ°? Ïπ†ÌïòÍ∏?
		buttonBox.add(BlueColorButton); //?çº?†áÍ≤? Ïπ†ÌïòÍ∏?
